...
/// Root iOS window content. Stacks the page surface above the bottom URL bar.
/// No `NavigationSplitView` — iPhone has no sidebar; the URL bar's ⋯ button
/// is the consolidated entry to bookmarks, history, settings, etc.
struct iOSRootView: View {
    ...
    private struct FindOnPageBar: View {
        @Environment(BrowserViewModel.self) private var browser
