...
The goal is native product quality per platform while preserving continuity in browser behavior:
...
- State: platform UIs should expose equivalent behavior even when the implementations are fully native.
